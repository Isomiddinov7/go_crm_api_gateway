...
const (
	LessonService_Create_FullMethodName  = "/users_service.LessonService/Create"
	LessonService_GetById_FullMethodName = "/users_service.LessonService/GetById"
	LessonService_GetList_FullMethodName = "/users_service.LessonService/GetList"
	LessonService_Update_FullMethodName  = "/users_service.LessonService/Update"
	LessonService_Delete_FullMethodName  = "/users_service.LessonService/Delete"
)
...
type LessonServiceClient interface {
	...
	Delete(ctx context.Context, in *LessonPrimaryKey, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *lessonServiceClient) Delete(ctx context.Context, in *LessonPrimaryKey, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type LessonServiceServer interface {
	...
	Delete(context.Context, *LessonPrimaryKey) (*Empty, error)
...
func (UnimplementedLessonServiceServer) Delete(context.Context, *LessonPrimaryKey) (*Empty, error) {
...
var LessonService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "users_service.LessonService",
