...
const (
	AssignStudentService_Create_FullMethodName  = "/users_service.AssignStudentService/Create"
	AssignStudentService_GetById_FullMethodName = "/users_service.AssignStudentService/GetById"
	AssignStudentService_GetList_FullMethodName = "/users_service.AssignStudentService/GetList"
	AssignStudentService_Update_FullMethodName  = "/users_service.AssignStudentService/Update"
	AssignStudentService_Delete_FullMethodName  = "/users_service.AssignStudentService/Delete"
)
...
type AssignStudentServiceClient interface {
	...
	Delete(ctx context.Context, in *AssignStudentPrimaryKey, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *assignStudentServiceClient) Delete(ctx context.Context, in *AssignStudentPrimaryKey, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type AssignStudentServiceServer interface {
	...
	Delete(context.Context, *AssignStudentPrimaryKey) (*Empty, error)
...
func (UnimplementedAssignStudentServiceServer) Delete(context.Context, *AssignStudentPrimaryKey) (*Empty, error) {
...
var AssignStudentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "users_service.AssignStudentService",
