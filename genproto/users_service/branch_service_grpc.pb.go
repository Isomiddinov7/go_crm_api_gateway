...
const (
	BranchService_Create_FullMethodName  = "/users_service.BranchService/Create"
	BranchService_GetById_FullMethodName = "/users_service.BranchService/GetById"
	BranchService_GetList_FullMethodName = "/users_service.BranchService/GetList"
	BranchService_Update_FullMethodName  = "/users_service.BranchService/Update"
	BranchService_Delete_FullMethodName  = "/users_service.BranchService/Delete"
)
...
type BranchServiceClient interface {
	...
	Delete(ctx context.Context, in *BranchPrimaryKey, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *branchServiceClient) Delete(ctx context.Context, in *BranchPrimaryKey, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type BranchServiceServer interface {
	...
	Delete(context.Context, *BranchPrimaryKey) (*Empty, error)
...
func (UnimplementedBranchServiceServer) Delete(context.Context, *BranchPrimaryKey) (*Empty, error) {
...
var BranchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "users_service.BranchService",
